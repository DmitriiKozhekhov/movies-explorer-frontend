  ...
  return(
    <div className={`moviesCard ${!savedList && "moviesCard"} ${(savedList && !saved) && "moviesCard_hider"}`}>
      ...
      <div className="moviesCard__nameLikeGroup">
        ...
        <button type="button" className={`moviesCard__button ${saved ? "moviesCard__saved": "moviesCard__like"} ${savedList && "moviesCard_hider"}`}></button> 
        <button type="button" className={`moviesCard__button ${savedList ? "moviesCard__deleteButton": "moviesCard_hider"}`}></button> 
      </div>
