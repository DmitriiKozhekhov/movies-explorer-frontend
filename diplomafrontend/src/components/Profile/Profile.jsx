  ...
  return(
    <main className="profile">
      ...
      <div className="profile__formInputGroup">
        ...
        <p className={`profile__error ${isValid && "profile__error_hidden"}`}>{errors.name || ''}</p>
        <div className="profile__formInputGroup">
        ...
        <p className={`profile__error ${!errors.email && "profile__error_hidden"}`}>{errors.email || ''}</p>
        <p className={`profile__message ${!message && "profile__message_hidden"}`}>Данные успешно обновлены</p>        
