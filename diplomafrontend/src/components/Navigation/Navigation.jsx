...
function Navigation({loggedIn}) {
  ...
  return (
        <Switch>
          <Route exact path="/">
            {loggedIn ? 
            <div className="navigation navigation_route_notMain">
            <div className="navigation__links navigation__links_route_movies navigation__links_adress_notMain">
              ...
              <Link to="/profile" className="navigation__link navigation__link_route_notMain">
                <button className={`navigation__button navigation__button_type_profile ${loggedIn && 'navigation__button_address_main'}`}><div className='navigation__accountLogo'></div><p className='navigation__buttonText'>Аккаунт</p></button>
              </Link>
            ...
            : 
          <div className="navigation navigation_route_main">
